...
async function batchDecode() {
  for (let index = 0; index < 100; index++) {
    ...
    dbr.decodeFileAsync("test.png", dbr.formats.OneD | dbr.formats.PDF417 | dbr.formats.QRCode | dbr.formats.DataMatrix | dbr.formats.Aztec,function(err,barcodeResults){
